  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-10">
      ...
      <form action={createBubbleAction} className="mt-6 space-y-5">
        ...
        <fieldset>
          <legend className="mb-1 block text-sm font-medium text-neutral-700">Visibility</legend>
          <div className="flex gap-3">
            <label className="flex-1 cursor-pointer rounded-md border border-neutral-300 p-3 text-sm has-[:checked]:border-neutral-900 has-[:checked]:bg-neutral-50">
