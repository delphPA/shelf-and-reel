...
export function AddItemForm({ bubbleId }: { bubbleId: string }) {
  ...
  return (
    <form action={addRecommendationAction} className="space-y-5">
      ...
      <fieldset>
        <legend className="mb-1 text-sm font-medium text-stone-700">What are you sharing?</legend>
        <div className="flex gap-3">
          <label className="flex-1 cursor-pointer rounded-md border border-stone-300 p-3 text-center text-sm has-[:checked]:border-amber-800 has-[:checked]:bg-amber-50">
            <input
              type="radio"
              name="type"
              value="BOOK"
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-stone-700" htmlFor="title">
          Title
        </label>
        <input
          id="title"
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-stone-700" htmlFor="creator">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="mb-1 block text-sm font-medium text-stone-700" htmlFor="genre">
            Genre
          </label>
          <select
            id="genre"
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-stone-700" htmlFor="ageSection">
            Section
          </label>
          <select
            id="ageSection"
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-stone-700" htmlFor="text">
...
function RatingInput() {
  ...
  return (
    <div>
      <label className="mb-1 block text-sm font-medium text-stone-700">Your rating</label>
